            ...
            <div class="card-body">
                ...
                <form wire:submit.prevent="saveCompanyInfo">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" wire:model.live="company_name"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" wire:model.live="ceo_name"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" class="form-control" wire:model.live="contact_email"
                    ...
                    <div class="mb-3 d-flex gap-3">
                        ...
                        <div class="flex-grow-1">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" wire:model.live="email_domain"
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select selectIndustry" wire:model.live="company_industry"
                            {{ $viewMode ? 'disabled' : '' }}>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select selectCompanyType" wire:model.live="company_type" {{ $viewMode ? 'disabled' : '' }}>
                    ...
                    <div class="row mt-3">
                        <div class="d-flex align-items-center">
                            ...
                            @if (!$is_parent)
                            <select wire:model.live="parent_company_id" id="parent_company" class="form-select w-50 ms-2"
                                {{ $viewMode ? 'disabled' : '' }}>
                    ...
                    <div class="row mt-3">
                        <div class="col-md-6">
                            ...
                            <input {{ $viewMode ? 'disabled' : '' }} type="text" class="form-control" wire:model.live="time_zone" readonly>
                        </div>

                        <div class="col-md-6">
                            <label class="form-label">Currency <span class="text-danger">*</span></label>
                            <input {{ $viewMode ? 'disabled' : '' }} type="text" class="form-control" wire:model.live="currency" readonly>
                        </div>
                    </div>
                    <div class="mb-3 mt-3">
                        <label class="form-label">Company Present Address <span class="text-danger">*</span></label>
                        <textarea class="form-control" wire:model.live="company_present_address" {{ $viewMode ? 'disabled' : '' }}></textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" wire:model.live="company_permanent_address"
                    ...
                    <div class="row mt-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="pf_no" wire:model.live="pf_no"
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="tan_no" wire:model.live="tan_no"
                                oninput="this.value = this.value.toUpperCase().replace(/[^A-Z0-9]/g, '')"
                    ...
                    <div class="row mt-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="pan_no" wire:model.live="pan_no"
                                oninput="this.value = this.value.toUpperCase().replace(/[^A-Z0-9]/g, '')"
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="esi_no" wire:model.live="esi_no"
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="lin_no" wire:model.live="lin_no"
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="gst_no" wire:model.live="gst_no"
                                oninput="this.value = this.value.toUpperCase().replace(/[^A-Z0-9]/g, '')"
                    ...
                    <div class="row mt-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="company_registration_no"
                                wire:model.live="company_registration_no"
                                oninput="this.value = this.value.toUpperCase().replace(/[^A-Z0-9\-\/]/g, '')"
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="date" id="company_registration_date" class="form-control"
                                wire:model.live="company_registration_date" max="{{ date('Y-m-d') }}"
                                {{ $viewMode ? 'disabled' : '' }}>
                    ...
                    <div class="mb-3 mt-3">
                        ...
                        <input type="text" class="form-control"
                            wire:model.live="company_website" {{ $viewMode ? 'disabled' : '' }}>
                    ...
                    <div class="mb-3 mt-3">
                        ...
                        <!-- File Input -->
                        <input type="file" class="form-control" wire:model.live="company_logo"
                            {{ $viewMode ? 'disabled' : '' }}>
