...
@endif
    ...
    <div class="col-md-5 bg-white d-flex justify-content-between align-items-center p-3 shadow" style="height: 70px; border-radius: 8px;">
        ...
        <div class="col-md-3">
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <input type="text" name="years" class="form-control" id="years_experience" >
                </div>
            </div>
        </div>
        ...
        <div class="row mt-2">
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <textarea name="nature_of_duties" class="form-control"></textarea>
                </div>
            </div>
            <div class="col-md-3">
                <div class="form-group">
                    <label>Leaving Reason</label>
                    <textarea name="leaving_reason" class="form-control"></textarea>
                </div>
            </div>
        </div>
        ...
        <div class="row mt-2">
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <input type="text" name="pf_member_id" class="form-control">
                </div>
            </div>
            <div class="col-md-3">
                <div class="form-group">
                    <label>Last Drawn Salary</label>
                    <input type="number" step="0.01" name="last_drawn_salary" class="form-control">
                </div>
            </div>
        </div>
...
<div class="row justify-content-center">
    ...
    <div class="col-md-5 p-1 text-center rounded">
        <div style="width: 100%; height: 30px; border-radius: 8px; background: #EEEEEE;"></div>
    </div>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function calculateExperience() {
            ...
            if (!isNaN(fromDate) && !isNaN(toDate) && fromDate <= toDate) {
                ...
                // Print the calculated experience in the console
