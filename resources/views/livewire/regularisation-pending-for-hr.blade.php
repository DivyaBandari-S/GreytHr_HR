    ...
    .side-container {
     ...
     <div class="row m-0 p-0">
            <div class="col-md-4 p-0 m-0 mb-2 ">
                <div aria-label="breadcrumb bg-none">
                    <ol class="breadcrumb d-flex align-items-center ">
                        <li class="breadcrumb-item"><a type="button" style="color:#fff !important;" class="submit-btn" href="/hr/user/hr-attendance-overview">Back</a></li>
        ...
        <div class="headers-details">
            <h6 style="padding-left:20px;">Regularisation Applied on {{ $regularisationrequest->created_at->format('d M, Y') }} </h6>
        </div>
