      ...
      <table id="employee-table">
        ...
        <tbody>
         ...
         <tr>
                <td>{{++$i}}.</td>
                <td>{{$s1->emp_id}}</td>
                <td>{{ucwords(strtolower($s1->employee->first_name))}} {{ucwords(strtolower($s1->employee->last_name))}}</td>
                <td>{{\Carbon\Carbon::parse($s1->from_date)->format('jS F Y')}}</td>
                <td>{{\Carbon\Carbon::parse($s1->to_date)->format('jS F Y')}}</td>
                <td>{{$s1->shift_type}}</td>
                <td>
