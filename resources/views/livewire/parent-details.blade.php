...
<div class="tab-content pt-5" id="tab-content">
  ...
  <div class="row justify-content-center"  >
    ...
    <div class="col-10">
        ...
        The Family Details page helps you to add or edit the family details of your employees. You can View, Add, Update and Delete information related to an employee's Family Members on the Family Members page.
        </p>
    </div>
...
@if($employee)
    ...
    <div class="card-row">
            ...
            <div class="col-md-3 edit-headings">Father's Address
                @if($currentEditingParentProfile == $employee->emp_id)
                    <div class="mb-2">
                        <input type="text" class="form-control mt-1 input-width" wire:model="FatherAddress" placeholder="Father's Address">
                    </div>
                @else
                    <div class="editprofile mb-3">
