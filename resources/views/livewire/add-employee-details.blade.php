    ...
    <div style="position: relative; ">
                        ...
                        <fieldset>
                            <div class=" m-0 row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select wire:change="selectedCompany" wire:model="com_id" class="form-control onboardinputs custom-select placeholder-small m-0" style="margin-bottom: 10px;">
                                ...
                                {{-- <div class="form-group col-md-6">
                                <label>Select Company/Companies<span class="text-danger onboard-Valid">*</span></label>
                                <div class="checkbox-list" style="max-height: 100px; height: auto; overflow-y: auto;border:1px solid  #ccc;border-radius:5px">
                                    @foreach($companieIds as $company)
                                    <div class="" height= "60">
                                        <input type="checkbox" style="margin-left: 5px; margin-bottom: 5px;"
                                            id="company{{ $company->company_id }}"
                                value="{{ $company->company_id }}"
                                wire:model="company_id"
                                wire:click="selectedCompany"
                                class="form-check-input"
                                @if(in_array($company->company_id, $company_id)) checked @endif>
                                <label class="form-check-label" for="company{{ $company->company_id }}">
        ...
        <fieldset>
            <div class=" m-0 row">
                ...
                <div class="form-group col-md-6">
                    <label class="mt-1" for="emp_domain"> Domain / Cost-Centers </label>
