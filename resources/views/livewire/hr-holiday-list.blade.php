<div>
    <style>
        ...
        .periodicity {
            ...
            /* Adjust the fraction values as needed */
            gap: 10px;
        ...
        <ul class="nav leave-grant-nav-tabs d-flex" id="myTab" role="tablist"
            ...
            <li class="leave-grant-nav-item" role="presentation">
                ...
                <button class="leave-grant-nav-link" id="dashboard-tab" data-bs-toggle="tab"
                    ...
                    aria-controls="dashboard-tab-pane" aria-selected="false">Activity</button>
            ...
            <div class="tab-pane show active" id="summary-tab-pane" role="tabpanel" aria-labelledby="summary-tab"
                    ...
                    <div class="px-3 py-2">
                        <div class="row main-overview-help">
                            <div class="col-md-11 col-10 d-flex flex-column">
                                <p class="main-overview-text mb-1">The <span class="msgHeighlighter">Holiday List
                                    </span> page displays all the holidays declared for the year. You can also manage
                                    the Holiday calendar here. You may define the same holidays across the organization
                                    or have a different list across various employee categories (Location, Factory, and
                                    so on).
                ...
                <div class="form-group task-date-range-picker">
                    <select class="form-select task-custom-select-width" wire:model.defer="filterPeriodValue"
                        ...
                        <option value="year_before_previous">Jan {{ date('Y') - 2 }} - Dec {{ date('Y') - 2 }}</option>
                    </select>
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-header text-white">
                                    <h6 class="modal-title " id="logoutModalLabel" style="align-items: center;">Delete
                                    </h6>
                                </div>
                                ...
                                <div class="d-flex gap-3 justify-content-center p-3">
                                    <button type="button" class="submit-btn "
                                        wire:click="deleteSelectedHolidays">Confirm</button>
                ...
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <button type="button" class="btn-close btn-primary" wire:click="close">
                        </div>
                                    ...
                                    <thead class="table-light"
                                        ...
                                        <tr>
                                            <th>
                                                ...
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox"
                                                        wire:model="selectAll1" wire:click="toggleSelectAll1" />
                                                </div>
                                            </th>
                                            <th>#</th>
                                            <th>Occasion</th>
