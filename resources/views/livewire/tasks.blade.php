                                                                                ...
                                                                                <div class="modal-dialog custom-modal-dialog custom-modal-dialog-centered custom-modal-lg" role="document">
                                                                                    <div class="modal-content custom-modal-content">
                                                                                            ...
                                                                                            <div id="imageCarousel" class="carousel slide" data-bs-ride="carousel">
                                                                                                ...
                                                                                                <ol class="carousel-indicators">
                                                                                                    @foreach ($images as $index => $image)
                                                                                                        <li data-bs-target="#imageCarousel" data-bs-slide-to="{{ $index }}" class="{{ $index === 0 ? 'active' : '' }}"></li>
                                                                                                    @endforeach
                                                                                                </ol>
                                                                                                ...
                                                                                                <div class="carousel-inner">
                                                                                                    @foreach ($images as $index => $image)
                                                                                                        ...
                                                                                                        <div class="carousel-item {{ $index === 0 ? 'active' : '' }}">
                                                                                                            <img src="data:{{ $mimeType }};base64,{{ $base64File }}" class="d-block w-100" alt="Image">
                                                                                                        </div>
                                                                                                    @endforeach
                                                                                                </div>
                                                                                        ...
                                                                                        <div class="modal-footer custom-modal-footer">
                                                                                            <button type="button" class="submit-btn" wire:click.prevent="downloadImage({{ $record->id }})">Download</button>
                                                                                            <button type="button" class="cancel-btn" wire:click="closeViewImage">Close</button>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="form-group mb-2">
                                    <label style="margin-bottom: 10px;">Due Date <span
                                            class="text-danger">*</span></label>
                                    <br>

                                    <input type="date" wire:model="newDueDate" wire:change="validateDueDate"
                                        style="    width: 50%;
    font-size: 0.75rem;
    padding: 5px;
    outline: none;
                            ...
                            <div class="modal-body">
                                <div class="task-container">
                                    ...
                                    <div class="form-group task-modal-assignee-container">
                                        ...
                                        <br>
                                        <i wire:click="forAssignee" wire:change="autoValidate"
                                            class="fa fa-user icon" id="profile-icon"></i>
                                    ...
                                    <div class="row task-modal-duedate-container">
                                        <div class="col">
                                            <div class="form-group">
                                                ...
                                                <br>
                                                <input wire:change="autoValidate" type="date"
                                                    wire:model="due_date" class="placeholder-small task-duedate-input"
                                        ...
                                        <div class="col">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input wire:change="autoValidate" type="text" wire:model="tags"
                                                    ...
                                                    class="placeholder-small task-tags-input">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="task-modal-followerlist-container">
                                            ...
                                            @else
                                                @foreach ($peopleFollowerData as $people)
                                                    <div class="container task-modal-follower-peoples-container">
                                                        <div class="row align-items-center">
                                                            <div class="col-auto">
                                    ...
                                    <div>
                                        <input type="file" wire:model="file_paths" id="file_paths"
                                            wire:change="fileSelected" wire:keydown="validateField('file_paths')"
                                            class="form-control task-modal-filepath" multiple>
                                        @error('file_paths')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                        ...
                                        <div class="comment mb-4 mt-2">
                                            ...
                                            <div class="col p-0 comment-content">
                                                @if ($editCommentId == $comment->id)
                                                    ...
                                                    <button
                                                        class="btn btn-secondary p-1 m-0 task-comment-edit-cancel-btn"
