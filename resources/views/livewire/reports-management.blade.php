<div >
    <style>
        .button-container-for-employee-swipes-for-reports {
    display: flex;
...
#searchButtonReportsForRegularisation
{
    position: absolute;
    right: 0;
    top: 50%;
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-footer d-flex justify-content-center">
                            ...
                            <button type="button" class="cancel-btn" wire:click="resetFields"
                                style="border:1px solid #306cc6;">Clear</button>
                        </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="table-responsive mt-2" style="height:200px;max-height:200px;overflow-y:auto;width:100%;">
                                <table class="swipes-table mt-2 border"style="width:100%;">
                                    ...
                                    @else
                                       <tr>
                                        <td colspan="12"style="text-align:center;">No selected Records Found</td>
                                       </tr>
                                    @endif  
                                </table>
                            </div>
                ...
                <div class="modal-body">
                                ...
                                <div class="button-container-for-employee-swipes-for-reports">
                                                ...
                                                <button class="my-button apply-button"
                                                    ...
                                                    style="background-color:{{ $isApply == 1 && $defaultApply == 1 ? '#306cc6' : '#fff' }};color: {{ $isApply == 1 && $defaultApply == 1 ? '#fff' : 'initial' }};"
                                                ...
                                                <button class="my-button history-button"
                                                    ...
                                                    style="background-color:{{ $isPending == 1 && $defaultApply == 0 ? '#306cc6' : '#fff' }};color: {{ $isPending == 1 && $defaultApply == 0 ? '#fff' : 'initial' }};"
