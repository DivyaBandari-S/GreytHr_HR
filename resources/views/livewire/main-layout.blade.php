    ...
    <div class="container-fluid">
        ...
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            ...
            <li class="nav-item" role="presentation">
                ...
                <button class="nav-link active" wire:click="setActiveTab('summary')">Welcome</button>
            ...
            <li class="nav-item" role="presentation">
                ...
                <button class="nav-link" wire:click="setActiveTab('dashboard')">Dashboard</button>
        ...
        <div class="tab-pane row m-0 mb-4">
        ...
        <div class="tab-pane bg-white p-1 d-flex flex-row justify-content-between  mb-2">
