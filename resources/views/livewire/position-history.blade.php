...
<i>                @if($editingProfile )
                    <i wire:click="cancelProfile('{{ $emp_id }}')" class="fas fa-times me-1" style="cursor: pointer;"></i>
...
<i style="margin-left:5px">             
     @if($currentEditingDomainProfileId == $employee->emp_id)
                    <i wire:click="cancelDomainProfile('{{ $emp_id }}')" class="fas fa-times " style="cursor: pointer;"></i>
                    <i wire:click="savedomainProfile('{{ $emp_id }}')" class="fa fa-save" style="cursor: pointer;"></i>
                @else
                    <i wire:click="editDomainProfile('{{ $emp_id }}')" class="fas fa-edit ml-auto" style="cursor: pointer;"></i>
                @endif
            </i> 
...
<i style="margin-left:5px">             
     @if($currentEditingdesignationProfileId == $employee->emp_id)
                    <i wire:click="canceldesignationProfile('{{ $emp_id }}')" class="fas fa-times " style="cursor: pointer;"></i>
...
<i style="margin-left:5px">                     
      @if($currentEditingDepPersonalProfileId == $employee->emp_id)
                    <i wire:click="cancelDepartmentProfile('{{ $emp_id }}')" class="fas fa-times me-3" style="cursor: pointer;"></i>
                    <i wire:click="saveDepartmentProfile('{{ $emp_id }}')" class="fa fa-save" style="cursor: pointer;"></i>
                @else
                    <i wire:click="editDepartmentProfile('{{ $emp_id }}')" class="fas fa-edit ml-auto" style="cursor: pointer;"></i>
                @endif
            </i> 
