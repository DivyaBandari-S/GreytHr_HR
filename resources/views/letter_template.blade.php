<div class="letter-preview-page">
    ...
    <div class="signature">
        ...
        <p><strong>{{ $previewLetter['authorized_signatory']->first_name }} {{ $previewLetter['authorized_signatory']->last_name }}</strong></p>
        <img src="data:image/png;base64,{{ base64_encode($previewLetter['authorized_signatory']->signature) }}" alt="Signature" style="width:150px; height:auto;">
        <p><strong>{{ $previewLetter['authorized_signatory']->designation }}</strong></p>
    </div>
    <div class="cc">
