...
body{
    ...
    <div style="padding: 0px 30px 0px 30px;">
        ...
        <p class="privacyContent">In the normal course of operations, Customers use the Service to store and manage Customer Data. This could include personally identifiable information ("PII") and non-personally identifiable information ("Non-PII").</p>
        <p class="privacyContent">
        ...
        <div class="row">
            ...
            <p class="privacyheadings"> Information we collect automatically</p>
        ...
        <div class="row">
            <p class="privacyheadings">Legal Basis for Processing Personal Information</p>
            <p class="privacyContent">We have a contractual obligation with the Customer to provide the Services as per our Terms of Use. If you are a visitor from the European Economic Area (EEA) and from a GDPR Compliance perspective, we are processing this information on behalf of Customer ("Controller") who has a legitimate interest in maintaining his employee information for the purpose of managing his business and adhering to his statutory compliance requirements.</p>
        </div>
        <div class="row">
            <p class="privacyheadings">Data Security</p>
            <p class="privacyContent">We take privacy seriously and take robust and reasonable security assures to protect Personal data from unauthorized access, maintains data accuracy, prevent alteration, disclosure and help ensure the appropriate use of the data. The measures we take include:</p>
            <span class="privacyContent">
                <li>When the service is accessed using modern web browsers, Transport Layer Security ("TLS") technology protects customer data using both server authentication and data encryption.</li>
            </span>
            <span class="privacyContent"> &nbsp; &nbsp; These technologies help ensure that the data is safe, secure and only available to the Users to whom the information belongs and those to whom the User has granted access.</span>
            <span class="privacyContent">
                <li>We follow security best practices (OWASP) for developing our applications and in our deployment / system administration.</li>
            </span>
            <span class="privacyContent">
                <li>We host our websites in a secure server environment that use firewalls and other advanced technology to prevent interference or access from intruders.</li>
            </span>
            <span class="privacyContent">
                <li>We encrypt the data at rest and transit.</li>
            </span>
            <span class="privacyContent">
                <li>We restrict access to only authorized personnel through password and two-factor authentication processes.</li>
            </span>
            <p class="privacyContent">If we learn of a security systems breach, then we may attempt to notify you electronically through our Site or by email so that you can take appropriate protective steps.</p </div>
            ...
            <div class="row">
                ...
                <li>
                    <span class="privacyContent">
                        <label class="privacyLabelContent">Related Entities: </label>
                        We may provide such information to our subsidiaries, affiliated companies for purposes consistent with this Privacy Policy.
                    </span>
                </li>
                ...
                <li>
                    <span class="privacyContent">
                        <label class="privacyLabelContent">Third Parties (Sub-Processors): </label>
                ...
                <li>
                <span class="privacyContent">
                    <label class="privacyLabelContent">Unrestricted information: </label>
                    Any information that you voluntarily choose to include in a Public Area of the Service or share with us through any other means, will be considered as "Unsolicited Information". This information will be available to any User or Visitor who has access to that content and shall be deemed to be non-confidential and we shall be free to reproduce, use, disclose, and distribute such Unsolicited Information to others without limitation or attribution.
                    </span>
                </li>
